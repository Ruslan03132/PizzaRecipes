...
public class RecipeActivity extends AppCompatActivity   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.titleRecipeTextView);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        favoriteItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            private void saveDataAddRecipe(){
                ...
                favoriteArrayItems.add(new InfoCardItem(intent.getIntExtra("imageResourse",0), intent.getIntExtra("title",0), intent.getIntExtra("description",0), intent.getIntExtra("recipe",0)));
                SharedPreferences sharedPreferences = getSharedPreferences("shared preferences", MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                Gson gson = new Gson();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case (R.id.favorite):
                        ...
                        if (flagOnCreate) {
                            Toast.makeText(RecipeActivity.this, "Рецепт удалён из Избранного!", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(RecipeActivity.this, "Рецепт добавлен в Избранное!", Toast.LENGTH_SHORT).show();
